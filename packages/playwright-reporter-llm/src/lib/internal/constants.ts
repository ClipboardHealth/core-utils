...
export const ACTION_LOG_MESSAGE_CAP = 512;
export const ACTION_LOG_MESSAGES_CAP = 20;
export const ACTION_SELECTOR_CAP = 256;
...
export const CLIENT_LIFECYCLE_ATTACHMENT_BYTES_CAP = 65_536;
export const CLIENT_LIFECYCLE_RECORDS_CAP = 100;
export const CLIENT_LIFECYCLE_PATH_CAP = 512;
export const CLIENT_LIFECYCLE_IDENTIFIER_CAP = 256;
