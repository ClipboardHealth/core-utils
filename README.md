...
<p align="center">
  <a href="https://www.clipboardworks.com/"><img alt="Clipboard logo." height="250px" src="./static/clipboard-engineering.png"></a>
</p>
<p align="center">
...
- [oxlint-plugin](./packages/oxlint-plugin/README.md): Clipboard's Oxlint plugin.
...
- [usa-states](./packages/usa-states/README.md): Canonical US state and territory list, StateCode and StateName types, and name/code normalizers.
...
- [groundcrew](https://github.com/ClipboardHealth/groundcrew): now lives in its own repository.
