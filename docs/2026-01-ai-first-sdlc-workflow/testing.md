...
1. Expected: Claude should guide you through creating a product brief
2. Test /sdlc:design
/sdlc:design Based on a user authentication brief
2. Expected: Claude should draft a technical design
3. Test /sdlc:code
/sdlc:code Implement a simple validation function
3. Expected: Claude should use TDD methodology
...
1. Expected: Hook should block and suggest delegating to product-manager
