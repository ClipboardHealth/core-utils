---
name: flaky-triage
description: "Triage stage between flake intake and dispatch: cluster flaky tickets by root cause, close duplicates and infra blips, release one canonical ticket per cluster."
---
