...
6. **Check for duplicates** — dispatch the `linear-duplicate-finder` skill with the debt description and draft title. If duplicates are found, present them to the user before proceeding.
