---
name: humanize-prose
description: "Strip AI writing tells from prose — PR descriptions, Slack messages, docs, commit messages. Use on 'humanize' or 'deslop', and implicitly for any prose you draft."
---
