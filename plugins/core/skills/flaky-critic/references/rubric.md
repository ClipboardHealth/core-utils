...
The 2026-07-16 B8 and prior-attempts blind backtest records the current-rule results, error decomposition, amendment proposals, and ratified live-monitoring handoff. It lives in the core-utils source repo under `references/backtests/` and is not shipped with the published skill.
