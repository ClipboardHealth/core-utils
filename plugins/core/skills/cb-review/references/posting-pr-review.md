...
**3. "Apply all comments at once" prompt.** A fenced block with a self-contained prompt the PR author can paste into an AI coding agent on a checkout of this branch:

````markdown
**Apply all comments at once** — paste this into your coding agent on a checkout of this branch:
